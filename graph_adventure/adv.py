...
roomGraph={0: [(3, 5), {'n': 1, 'e': 2}], 1: [(3, 6), {'s': 0}], 2: [(4, 5), {'w': 5, 'n': 4, 'e': 0}], 3:[(5,6), {'s': 5}], 4:[(4,6), {'s': 2}], 5: [(5,5), {'e': 2, 'n': 3}]}
...
path = []
def dfs(first_node, path, lengthOfRoom):
    s = []
    s.append(first_node)
    dfs_visited = {}
    color_dfs = {}
...
first_dfs = dfs(player.currentRoom, path, len(roomGraph))
display_this = []
